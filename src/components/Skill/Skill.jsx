...
export default function Skill() {
  return (
    <div className="mt-36 w-[80%] mx-auto">
      <div className="">
        <h1 className="flex max-[768px]:text-5xl max-[1024px]:py-2 justify-center font-bold text-6xl text-transparent bg-gradient-to-tr py-4 from-[#f10ba4] via-orange-500 to-[#fbf01a] bg-clip-text mb-6">
          My Skills
        </h1>
        <div className="grid lg:grid-cols-1 xl:grid-cols-2 2xl:grid-cols-4 my-20 max-[1024px]:my-10 gap-5 max-[1024px]:gap-0">
          <div className="min-w-[320px] max-[1024px]:mb-4 flex flex-col items-center rounded-2xl shadow-2xl hover:scale-105 duration-700 px-6 py-4">
            <span className="">
            ...
            <div className="flex flex-col justify-start items-start w-[100%] mt-12">
              <div className="flex items-center justify-between w-full mb-2">
                ...
                <p className="text-xl font-bold text-gray-600">95%</p>
              </div>
              <div className="flex items-center justify-between w-full mb-2">
                <h1 className="text-xl font-semibold text-gray-600">
                  JavaScript
                </h1>
                <p className="text-xl font-bold text-gray-600">85%</p>
              </div>
              <div className="flex items-center justify-between w-full mb-2">
                <h1 className="text-xl font-semibold text-gray-600">PHP</h1>
                <p className="text-xl font-bold text-gray-600">92%</p>
              </div>
              <div className="flex items-center justify-between w-full mb-2">
          ...
          <div className="min-w-[320px] max-[1024px]:mb-4 flex flex-col items-center rounded-2xl shadow-2xl hover:scale-105 duration-700 px-6 py-4">
            ...
            <div className="flex flex-col justify-start items-start w-[100%] mt-12">
              ...
              <div className="flex items-center justify-between w-full mb-2">
                ...
                <p className="text-xl font-bold text-gray-600">98%</p>
              </div>
              <div className="flex items-center justify-between w-full mb-2">
          ...
          <div className="min-w-[320px] max-[1024px]:mb-4 flex flex-col items-center rounded-2xl shadow-2xl hover:scale-105 duration-700 px-6 py-4">
            ...
            <div className="flex flex-col justify-start items-start w-[100%] mt-12">
              ...
              <div className="flex items-center justify-between w-full mb-2">
                ...
                <p className="text-xl font-bold text-gray-600">96%</p>
              </div>
              <div className="flex items-center justify-between w-full mb-2">
                <h1 className="text-xl font-semibold text-gray-600">
                  Xampp Server
          ...
          <div className="min-w-[320px] max-[1024px]:mb-8 flex flex-col items-center rounded-2xl hover:scale-105 shadow-2xl duration-700 px-6 py-4">
            <span>
            ...
            <div className="flex flex-col justify-start items-start w-[100%] mt-12">
              ...
              <div className="flex items-center justify-between w-full mb-2">
                <h1 className="text-xl font-semibold text-gray-600">Adobe Photoshop</h1>
                <p className="text-xl font-bold text-gray-600">99%</p>
              </div>
            </div>
          </div>
